...
get_config() {
	...
	download https://raw.githubusercontent.com/thebrownbreadtoast/listmonk/master/config.toml.sample config.toml
}

get_containers() {
	info "fetching docker-compose.yml from listmonk repo"
	download https://raw.githubusercontent.com/thebrownbreadtoast/listmonk/master/docker-compose.yml docker-compose.yml
}
